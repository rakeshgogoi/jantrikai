...
export const metadata: Metadata = {
  ...
  description:
    'The terms governing use of Jantrik AI and its products - Jantra Web, Jantra Bot, and Jantra World - operated by Coding Ryder Enterprises.',
  alternates: { canonical: '/terms/' },
  openGraph: {
    title: 'Terms & Conditions - Jantrik AI',
    description:
      'Terms governing use of Jantra Web, Jantra Bot, and Jantra World.',
    url: '/terms/',
    type: 'website',
  },
};
...
const sections = [
  ...
  { id: 'world-disclaimer', title: '9. Jantra World - informational only' },
        ...
        <div className="container-page section">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="prose-lead mt-5 !leading-7 sm:!leading-8">
              ...
              Jantra Web, Jantra Bot, and Jantra World.
            </p>
            ...
            <div className="mt-10 space-y-12 text-[15px] leading-7 text-slate-700">
              <Section id="acceptance" title="1. Acceptance of these terms">
                <p>
                  ...
                  Jantra World (each a &ldquo;Service&rdquo;), you agree to be
              ...
              <Section id="services" title="3. The services">
                ...
                <ul className="mt-3 list-disc space-y-1.5 pl-5">
                  ...
                  <li>
                    <strong>Jantra World</strong> - a WhatsApp-delivered
                    multilingual AI assistant for international users, with a
                    language and voice mix tuned for the regions we ship in.
                  </li>
                </ul>
                <p className="mt-3">
              ...
              <Section id="accounts" title="6. Accounts & identification">
                <ul className="list-disc space-y-1.5 pl-5">
                  <li>
                    <strong>Jantra Bot &amp; Jantra World:</strong> your
              ...
              <Section id="world-disclaimer" title="9. Jantra World - informational only">
                <p>
                  Jantra World is a general-purpose AI assistant delivered on
                  WhatsApp. Its responses are generated by AI and are{' '}
                  <strong>
                    not professional advice
                  </strong>{' '}
                  (medical, legal, financial, immigration, tax, or otherwise).
                  Information may be outdated, incomplete, or inaccurate. Always
                  verify important information with the relevant official source
                  before acting.
                </p>
              </Section>
              ...
              <Section id="ip" title="11. Intellectual property">
                <p>
                  The Jantrik AI, Jantra Web, Jantra Bot, Jantra World, and
